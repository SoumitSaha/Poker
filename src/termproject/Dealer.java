...
public class Dealer {
    ...
    public void play() throws IOException, ClassNotFoundException {
        ...
        if (!folded) {
            ...
            System.out.println("Player 1 win rank :" + finalmsg1.rank);
            System.out.println("Player 2 win rank :" + finalmsg2.rank);
    ...
    public void bet02() throws IOException, ClassNotFoundException {
        while (CheckPersonNo < 2 && !folded) {
            switch (DealNo % 2) {
                case 1:
                    CommunicationMsg temp = ReqForBetOrMatchOrFold02(2);
                    if (temp.choice == 1) { //match
                        ...
                        DealNo++;
                        System.out.println("Deal No updated");
                        CheckPersonNo++;
                    ...
                    break;
                case 0:
                    temp = ReqForBetOrMatchOrFold02(1);
                    if (temp.choice == 1) {
                        System.out.println("Player " + temp.playerID + " matched");
                        pot = pot + temp.Bet;
                        msg2.Bet = temp.Bet;
    ...
    public void bet03() throws IOException, ClassNotFoundException {
        while (CheckPersonNo < 2 && !folded) {
            switch (DealNo % 2) {
                case 1:
                    CommunicationMsg temp = ReqForBetOrMatchOrFold03(2);
                    if (temp.choice == 1) { //match
                    ...
                    break;
                case 0:
                    temp = ReqForBetOrMatchOrFold03(1);
                    if (temp.choice == 1) {
                        System.out.println("Player " + temp.playerID + " matched");
                        pot = pot + temp.Bet;
                        msg2.Bet = temp.Bet;
    ...
    public void bet04() throws IOException, ClassNotFoundException {
        while (CheckPersonNo < 2 && !folded) {
            switch (DealNo % 2) {
                case 1:
                    CommunicationMsg temp = ReqForBetOrMatchOrFold04(2);
                    if (temp.choice == 1) { //match
                    ...
                    break;
                case 0:
                    temp = ReqForBetOrMatchOrFold04(1);
                    if (temp.choice == 1) {
                        System.out.println("Player " + temp.playerID + " matched");
                        pot = pot + temp.Bet;
                        msg2.Bet = temp.Bet;
    ...
    public void bet05() throws IOException, ClassNotFoundException {
        while (CheckPersonNo < 2 && !folded) {
            switch (DealNo % 2) {
                case 1:
                    CommunicationMsg temp = ReqForBetOrMatchOrFold05(2);
                    if (temp.choice == 1) { //match
                    ...
                    break;
                case 0:
                    temp = ReqForBetOrMatchOrFold05(1);
                    if (temp.choice == 1) {
                        System.out.println("Player " + temp.playerID + " matched");
                        pot = pot + temp.Bet;
                        msg2.Bet = temp.Bet;
    ...
    public CommunicationMsg ReqForBetOrMatchOrFold02(int i) throws IOException, ClassNotFoundException {
        CommunicationMsg temp = null;
    ...
    public CommunicationMsg ReqForBetOrMatchOrFold03(int i) throws IOException, ClassNotFoundException {
        CommunicationMsg temp = null;
        //int i = (int) InGamePlayers.get(TurnNo % InGamePlayers.size());
        switch (i) {
            case 1:
    ...
    public CommunicationMsg ReqForBetOrMatchOrFold04(int i) throws IOException, ClassNotFoundException {
        CommunicationMsg temp = null;
        //int i = (int) InGamePlayers.get(TurnNo % InGamePlayers.size());
        switch (i) {
            case 1:
    ...
    public CommunicationMsg ReqForBetOrMatchOrFold05(int i) throws IOException, ClassNotFoundException {
        CommunicationMsg temp = null;
        //int i = (int) InGamePlayers.get(TurnNo % InGamePlayers.size());
        switch (i) {
            case 1:
